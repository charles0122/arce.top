...
import HeroMain from "./img/cover.svg";
      ...
      <div className={styles.bloghome__intro}>
        <animated.div style={animatedTexts[0]} className={styles.hero_text}>
          ...
          <span className={styles.intro__name}>
            <Translate description="my name">  Arce</Translate>
          </span>
        </animated.div>
        ...
        {/* <animated.div style={animatedTexts[2]}>
          <Button
            ...
            href={translate({
              ...
              message:
                "https://space.bilibili.com/223987409?from=search&seid=1788147379248960737",
...
function SocialLinks({ animatedProps, ...props }) {
  ...
  return (
    <animated.div className={styles.social__links} style={animatedProps}>
      <a href="https://space.bilibili.com/223987409">
        <BilibiliIcon />
      </a>
      {/* <a href="https://www.linkedin.com/in/zxuqian/">
        <FontAwesomeIcon icon={faLinkedin} size="lg" />
      </a> */}
      <a href="https://github.com/charles0122">
...
<a href="https://gitee.com/charles0122">
      ...
      <div className={`dropdown ${styles.dropdown} dropdown--hoverable`}>
        ...
        <img
          ...
          src={useBaseUrl("/img/publicQR.bmp")}
        />
      </div>
    </animated.div>
  );
